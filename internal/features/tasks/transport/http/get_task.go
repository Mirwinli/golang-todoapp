...
// GetTask godoc
// @Summary Отримання задачі
// @Description Отримання конкретної задачі по її ID
// @Tags tasks
// @Produce json
// @Param id path int true "ID отримуваної задачі"
// @Succes 200 {object} GetTaskResponse "Задача успішно знайдена"
